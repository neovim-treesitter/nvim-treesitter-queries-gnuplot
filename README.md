# nvim-treesitter-queries-gnuplot

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-gnuplot/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-gnuplot/actions/workflows/validate.yml)

Neovim tree-sitter queries for **gnuplot**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-gnuplot",
...
- [ ] Changes are scoped to `gnuplot` — do not include files for other languages
